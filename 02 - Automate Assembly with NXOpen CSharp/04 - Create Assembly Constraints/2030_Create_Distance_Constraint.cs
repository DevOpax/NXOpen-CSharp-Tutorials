...
namespace Constraints
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
				...
				*/
				...
				AddDistance(workPart, 120, 200, 0);
		...
		public static void AddDistance(Part prt, double distance, double upper, double lower)
		{
			...
			if (cnt == 2)
			{
				...
				if (comp1 != comp2)
				{
					...
					constr.Expression.SetFormula(distance.ToString());
					constr.UpperLimitEnabled = true;
					constr.LowerLimitEnabled = true;

					constr.UpperLimitRightHandSide = upper.ToString();
					constr.LowerLimitRightHandSide = lower.ToString();
