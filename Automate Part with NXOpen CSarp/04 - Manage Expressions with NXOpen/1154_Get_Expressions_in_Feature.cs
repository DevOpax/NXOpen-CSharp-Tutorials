    ...
    public class Exercice
    {
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
				...
				//Read all expressions in a specific feature
				NXOpen.Features.Feature feature = WorkPart.Features.FindObject("EXTRUDE(2)");
														
				Expression[] exps = feature.GetExpressions();
