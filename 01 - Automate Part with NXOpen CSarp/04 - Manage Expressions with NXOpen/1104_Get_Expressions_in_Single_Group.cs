...
namespace Expressions
{
    public class Exercice
    {
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
				//Read All Expressions in a part by Group
				ListingWindow Lw = theSession.ListingWindow;
				Lw.Open();
				
				ExpressionGroup groups = WorkPart.ExpressionGroups.FindObject("Hub Diameters");
				
				foreach (Expression exp in groups.GetExpressions())
				{
